...
const renewStripeSubscription = async () => {
  ...
  {/* <button
    ...
    className="flex items-center gap-2 cursor-pointer px-6 py-3 rounded-lg bg-[#635BFF] hover:bg-[#5851db] text-white font-semibold shadow-md transition-all duration-200 min-w-[120px]"
  >
  ...
  {/* PayPal Buttons (3 funding sources) */}
